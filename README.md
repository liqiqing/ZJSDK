...
视频内容集成注意事项：
一：build phases点左上角+号添加copyfile ，copyfile 中点+号添加快手依赖库KSAdSDK.framework
二：embed frameworks 同样添加快手依赖库
三：编译模式选择老的编译模式：file- workspaceSetting-buildSystem-legacy build system，同时勾选Do not show a dialognostic......，
