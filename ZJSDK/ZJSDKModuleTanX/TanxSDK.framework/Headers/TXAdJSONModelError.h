...
/////////////////////////////////////////////////////////////////////////////////////////////
typedef NS_ENUM(int, kTXAdJSONModelErrorTypes)
{
    kTXAdJSONModelErrorInvalidData = 1,
    kTXAdJSONModelErrorBadResponse = 2,
    kTXAdJSONModelErrorBadJSON = 3,
    kTXAdJSONModelErrorModelIsInvalid = 4,
    kTXAdJSONModelErrorNilInput = 5
};

/////////////////////////////////////////////////////////////////////////////////////////////
/** The domain name used for the JSONModelError instances */
extern NSString *const TXAdJSONModelErrorDomain;
 ...
 */
extern NSString *const kTXAdJSONModelMissingKeys;
 ...
 */
extern NSString *const kTXAdJSONModelTypeMismatch;
 ...
 */
extern NSString *const kTXAdJSONModelKeyPath;
 ...
 */
@interface TXAdJSONModelError : NSError
