...
typedef NSString *(^TXAdJSONModelKeyMapBlock)(NSString *keyName);
 ...
 * </pre>
 */
@interface TXAdJSONKeyMapper : NSObject

// deprecated
@property (readonly, nonatomic) TXAdJSONModelKeyMapBlock JSONToModelKeyBlock DEPRECATED_ATTRIBUTE;
...
- (instancetype)initWithJSONToModelBlock:(TXAdJSONModelKeyMapBlock)toModel modelToJSONBlock:(TXAdJSONModelKeyMapBlock)toJSON DEPRECATED_MSG_ATTRIBUTE("use initWithModelToJSONBlock:");
+ (instancetype)mapper:(TXAdJSONKeyMapper *)baseKeyMapper withExceptions:(NSDictionary *)exceptions DEPRECATED_MSG_ATTRIBUTE("use baseMapper:withModelToJSONExceptions:");
...
@property (readonly, nonatomic) TXAdJSONModelKeyMapBlock modelToJSONKeyBlock;
 ...
 */
- (instancetype)initWithModelToJSONBlock:(TXAdJSONModelKeyMapBlock)toJSON;
 ...
 * Use your JSONModel property names as keys, and the JSON key names as values.
 */
+ (instancetype)baseMapper:(TXAdJSONKeyMapper *)baseKeyMapper withModelToJSONExceptions:(NSDictionary *)toJSON;
